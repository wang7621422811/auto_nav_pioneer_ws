...
#include "auto_nav_pioneer_interfaces/msg/detail/waypoint_list__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const auto_nav_pioneer_interfaces::msg::Waypoint &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Member: waypoints
  {
    ...
    for (size_t i = 0; i < size; i++) {
      auto_nav_pioneer_interfaces::msg::typesupport_fastrtps_cpp::cdr_serialize(
  ...
  auto_nav_pioneer_interfaces::msg::WaypointList & ros_message)
{
  ...
  // Member: waypoints
  {
    ...
    for (size_t i = 0; i < size; i++) {
      auto_nav_pioneer_interfaces::msg::typesupport_fastrtps_cpp::cdr_deserialize(
  ...
  size_t current_alignment)
{
  ...
  // Member: waypoints
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        auto_nav_pioneer_interfaces::msg::typesupport_fastrtps_cpp::get_serialized_size(
  ...
  size_t current_alignment)
{
  ...
  // Member: waypoints
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        auto_nav_pioneer_interfaces::msg::typesupport_fastrtps_cpp::max_serialized_size_Waypoint(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = auto_nav_pioneer_interfaces::msg::WaypointList;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Member: waypoints
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; i++) {
      auto_nav_pioneer_interfaces::msg::typesupport_fastrtps_cpp::cdr_serialize_key(
        ros_message.waypoints[i],
        cdr);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Member: waypoints
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        auto_nav_pioneer_interfaces::msg::typesupport_fastrtps_cpp::get_serialized_size_key(
        ros_message.waypoints[index], current_alignment);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Member: waypoints
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        auto_nav_pioneer_interfaces::msg::typesupport_fastrtps_cpp::max_serialized_size_key_Waypoint(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
{
  auto typed_message =
    static_cast<const auto_nav_pioneer_interfaces::msg::WaypointList *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<auto_nav_pioneer_interfaces::msg::WaypointList *>(
    untyped_ros_message);
...
{
  return &auto_nav_pioneer_interfaces::msg::typesupport_fastrtps_cpp::_WaypointList__handle;
}
