    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'auto_nav_pioneer_interfaces.msg.WaypointList')
            logger.debug(
...
class WaypointList(metaclass=Metaclass_WaypointList):
    ...
    _fields_and_field_types = {
        ...
        'waypoints': 'sequence<auto_nav_pioneer_interfaces/Waypoint>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['auto_nav_pioneer_interfaces', 'msg'], 'Waypoint')),  # noqa: E501
    )
